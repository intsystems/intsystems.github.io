...
- YouTube: [youtube.com/@MachineLearningIS](https://www.youtube.com/@MachineLearningIS)
...
- **2 сентября:** Подача заявок на [стипендию К.В. Рудакова]({{ site.baseurl }}/materials/scholarship)
- **7 сентября:** Начало занятий на кафедре
...
- **19 декабря:** ❗️ Зачет по исследовательской работе (научная статья/код/презентация)
...
- **23 мая:** 15:00 (суббота) Зачет по научной работе для студентов 3-го-6-го курсов и аспирантов
- **18-24 мая:** Зачетная неделя для студентов 3-го-6-го курсов
